...
const myModule = require('../01os核心模块-获取IPV4地址')
// 下载依赖包 npm i

// 2.创建
const server = http.createServer()
const getIP = myModule.getIPV4()

// 3.开启
server.listen(3000,()=>{
    console.log(`server is running at port http://${getIP}:3000/api/news`)
    console.log(`server is running at port http://${getIP}:3000/api/students`)
    console.log(`server is running at port http://${getIP}:3000/api/luckystar`)
})
